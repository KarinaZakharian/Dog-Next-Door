        ...
        <section className="fonctionnality">
          <div className="fonctionnality__card">
            ...
            <p className="fonctionnality__content">
              ...
              Offrez l&apos;hospitalité à l&apos;animal d&apos;un autre membre,
              et en retour, votre propre compagnon est accueilli chez eux, le
              tout gratuitement. Ainsi, l&apos;hébergement de vos petits amis
              reste accessible et basé sur un échange équitable et bienveillant.
            </p>
          </div>
          <div className="fonctionnality__card">
            ...
            <p className="fonctionnality__content">
              ...
              sera choyé par une communauté fiable et attentionnée à deux pas de
              votre domicile.
            </p>
          </div>
          <div className="fonctionnality__card">
            ...
            <p className="fonctionnality__content">
              ...
              communauté. Nous mettons un point d&apos;honneur à vérifier chaque
              profil pour que vous puissiez confier votre animal avec une
              tranquillité d&apos;esprit absolue. O&apos;Dog Next Door, votre
              réseau de pet sitting de confiance !
            </p>
          </div>
        </section>
        <section className="marketing">
          ...
          <div className="marketing__right-space">
            ...
            <p className="marketing__content">
              ...
              précieux est au cœur de notre mission. En confiant votre animal à
              notre communauté de pet sitters dévoués, non seulement vous
          ...
          <div className="testimonials__cards">
            ...
            <div className="testimonials__card">
              ...
              <p className="testimonials__card-content">
                ...
                est revenu de son séjour aussi joyeux et détendu que nous de nos
